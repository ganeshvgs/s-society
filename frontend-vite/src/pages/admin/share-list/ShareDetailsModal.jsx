...
export default function ShareDetailsModal({ share, onClose, refreshShares }) {
  ...
  const handleAddWithdrawal = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/share/withdraw/${share._id}`,
        withdrawalForm,
  ...
  const handleUpdate = async () => {
    try {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_API_URL}/api/share/${share._id}/purchase/${editingIndex}`,
        editData,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const handleDelete = async (index) => {
    ...
    try {
      ...
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/share/${share._id}/purchase/${index}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
